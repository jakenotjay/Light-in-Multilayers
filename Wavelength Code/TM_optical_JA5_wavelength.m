...
% input file is layers data
% layers has format Layer Number, Layer Thickness (nm), Refractive Index
...
lamda_min=800 ;               %minimum wavelength (nm)
lamda_max=1000;               %maximum wavelength (nm)		
npoints=400;                 %number of points in wavelength scan
